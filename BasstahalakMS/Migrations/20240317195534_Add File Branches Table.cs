...
{
    /// <inheritdoc />
    public partial class AddFileBranchesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileBranches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileBranches_BFiles_BFileId",
                        column: x => x.BFileId,
                        principalTable: "BFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileBranches_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileBranches_BFileId",
                table: "FileBranches",
                column: "BFileId");

            migrationBuilder.CreateIndex(
                name: "IX_FileBranches_BranchId",
                table: "FileBranches",
                column: "BranchId");
        }
