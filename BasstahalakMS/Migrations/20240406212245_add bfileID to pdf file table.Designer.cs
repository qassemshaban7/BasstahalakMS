...
namespace BasstahalakMS.Migrations
{
    ...
    [Migration("20240406212245_add bfileID to pdf file table")]
    partial class addbfileIDtopdffiletable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasstahalakMS.Models.PdfFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BasstahalakMS.Models.ReviewPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReviewPermissions");
                });

            modelBuilder.Entity("BasstahalakMS.Models.UserReviewPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserReviewPermissions");
                });

            modelBuilder.Entity("BasstahalakMS.Models.pdfNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BasstahalakMS.Models.UserReviewPermission", b =>
                {
                    b.HasOne("BasstahalakMS.Models.ReviewPermission", "ReviewPermission")
                        .WithMany("UserReviewPermissions")
            ...
            modelBuilder.Entity("BasstahalakMS.Models.pdfNote", b =>
                {
                    b.HasOne("BasstahalakMS.Models.PdfFile", "PdfFile")
                        .WithMany()
                        .HasForeignKey("PdfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BasstahalakMS.Models.ReviewPermission", b =>
                {
                    b.Navigation("UserReviewPermissions");
                });
